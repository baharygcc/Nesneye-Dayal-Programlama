public static void main(String[] args) {
	...
	public Calculator() {
		...
		input.setBounds(0, 22, 304, 52);
		screen.add(input);
		input.setBackground(SystemColor.inactiveCaptionBorder);
		...
		lbl.setBounds(0, 0, 304, 24);
		screen.add(lbl);
		
		JPanel control = new JPanel();
		control.setBackground(SystemColor.menu);
		control.setBounds(10, 74, 304, 331);
